"""lcbo_go_19501 URL Configuration
...
admin.site.site_header = "LCBO Go"
admin.site.site_title = "LCBO Go Admin Portal"
admin.site.index_title = "LCBO Go Admin"

# swagger
api_info = openapi.Info(
    title="LCBO Go API",
    default_version="v1",
    description="API documentation for LCBO Go App",
)
